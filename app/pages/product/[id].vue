...
useHead({
  ...
  meta: [
    { name: 'description', content: 'AST Telecom Company offers the best Earbuds. Discover affordable plans, latest smartphones, and top customer support. Switch to AST today!, Abdulrehman Sapra Telecom' },
